---
title: "Tools for Digital Twins - package dtLife"
...
The package dtLife contains tools that will be useful for making digital twins that deal with specific topics.
...
* *WadTempLR* contains low resolution surface water temperature from Waddensea stations in 2021.
...
par(mfrow=c(2,2))
Weather235 <- subset(Weather2021, subset=station==235)
plot(Weather235, type="l")
```

## Abiotic conditions - water temperature

* *WadTempLR* contains water temperatures, at roughly monthly resoltuion, for several station in the Waddensea
...
plot(WadTempLR, mfrow=c(3,4), type="l", las=1, ylab="dgC")
```
