# ==============================================================================
# ==============================================================================
# Calculate the mean y/x aspect ratio for latitudinal coordinates
# ==============================================================================
# ==============================================================================

aspect_coord <- function(latitude) {
  asp  <- 1/cos((mean(latitude, na.rm = TRUE)*pi)/180)  # y/x aspect ratio
}
# ==============================================================================
# ==============================================================================
# spatial conversion of coordinates
# ==============================================================================
# ==============================================================================

# ==============================================================================
# From dutch system to longitude/latitude
# ==============================================================================

xy_to_wgs84 <- function(X, Y,     # coordinates used in Dutch system
                        EPSG = 25831){
...
# ==============================================================================
# From longitude/latitude to dutch system 
# ==============================================================================

wgs84_to_xy <- function(longitude, latitude, 
                        EPSG = 25831){
  
  # WGS84=EPSG4326
  SS <- data.frame(longitude = longitude, 
                   latitude  = latitude)
...
rd_to_wgs84 <- function(X, Y) {
  ...
  data.frame(longitude = longitude*1e-5, 
