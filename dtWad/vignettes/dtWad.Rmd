...
* *WadGrain* is a dataset with sediment characteristics in the Waddensea.
* *Weather2021* contain wind speeds, light intensity, and radiation for the year 2021.
* *HT2021* contains water surface elevation (height) and surface water temperature from a few stations in 2021.
...
* *Marsdiep* and *WadDepth* contain the bathymetry of the marsdiep area and the Dutch  respectively.
...
mtext(outer=TRUE, side=3, "Datasets WadDepth and Marsdiep", cex=1.5)
